...
export default function Minimogview({ Minimodata, viewmodal, handleView }) {
  const [thumbsclick, setThumbs] = useState(0);
  const [tabsd, setTabs] = useState(1);
  return (
    <>
      {viewmodal ? (
        <div className="minimogview-container bg-opacity-75 fixed grid place-items-center top-0 right-0 left-0 bottom-0 bg-black z-10">
          <div className="view-item relative bg-white w-[75%] h-[78%] scrollbar-thin scrollbar-thumb-[#aaa] scrollbar-track-[#eee]  overflow-y-scroll">
            <div className="close  space-y-3">
              <div
                onClick={handleView}
                className="text-right p-3 w-[50px] h-[50px]
            bg-white grid place-items-center 
            absolute text-[1.3rem] top-0 rounded-full right-2 shadow-2xl text-black "
              >
                    ...
                    <div className="bg-thumbs overflow-hidden relative group group-hover:opacity-50 ">
                      <img
                        ...
                        onTouchMove={() => {
                          ...
                          const newSlide = isLeftside
                            ? Minimodata.productsingleimage.length - 1
                            : thumbsclick - 1;
                          setThumbs(newSlide);
                        }}
                        src={Minimodata.productsingleimage[thumbsclick].image}
                        alt=""
                      />
                ...
                <div className="row md:w-[50%] md:space-y-6 md:mt-5 ">
                  ...
                  <div className="color space-y-3">
                    ...
                    <div className="cplpr flex space-x-3">
                      <div className="w-[36px] h-[36px] border rounded-full p-1">
